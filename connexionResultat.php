...
if (isset($_POST['submit'])) {
	...
	$donnees=$resultatfinal->execute(array('1',$result,'1','1','20'));

?>

</table><br><br>

<a href="Examenblanc2.php" style="width: 300px;
	padding: 50px;
	position: absolute;
	background: #191919;
	text-align:  center;
	margin-left:45%;"><u>Passer a l'examen blanc 2</u></a><br><br><br><br><br><br><br><br><br><br><br><br>
